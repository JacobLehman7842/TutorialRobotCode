...
public class RobotContainer {
  ...
  private final ExtraMotor m_extramotor = new ExtraMotor();
  private final Joystick j_joystick =  new Joystick(Constants.Controls.CONTROLS_USB_JOYSTICK);
  private final JoystickButton b_spin = new JoystickButton(j_joystick, Constants.Controls.BUTTON_SPIN);
  ...
  private void configureButtonBindings() {
    ...
    b_spin.whileHeld(new SpinMotor(m_extramotor));
  }
